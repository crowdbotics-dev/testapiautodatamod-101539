...
## Project Structure
    ...
    ├── testapiautodatamod_101539  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_101539`
...
2. Clone this repo and `cd testapiautodatamod_101539`
